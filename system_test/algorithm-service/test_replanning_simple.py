...
spec = importlib.util.spec_from_file_location(
    "service_simple",
    Path(__file__).parent / "replanning" / "service_simple.py"
)
service_simple = importlib.util.module_from_spec(spec)
spec.loader.exec_module(service_simple)

# 加载models模块
spec = importlib.util.spec_from_file_location(
    "models",
    Path(__file__).parent / "replanning" / "models.py"
)
models = importlib.util.module_from_spec(spec)
spec.loader.exec_module(models)

SimpleReplanningService = service_simple.SimpleReplanningService
DepotInput = models.DepotInput
CustomerInput = models.CustomerInput
RouteInput = models.RouteInput
BlockedEdgeInput = models.BlockedEdgeInput
